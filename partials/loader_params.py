...
def build_loader_params():
    ...
    '''
    loader = dbc.Row(style={'width': '100%','display': 'flex', 'justifyContent': 'center', 'alignItems': 'center', 'flexDirection': 'row'}, className='d-flex justify-content-center align-items-center', children=[
            dbc.Row(
                dbc.Col(
